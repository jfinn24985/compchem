...
#include "supplier/ccfilter/ccfilter_app.hpp"
 ...
 */
std::string ccfilter_app::memo_src_location(const boost::filesystem::path & a_path, const std::string& a_memo_label) 
{
 ...
 */
void ccfilter_app::register_options() 
{
