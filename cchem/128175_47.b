class gui_state
!!!133679.cpp!!!	bind_control(inout a_attribute : ) : void
// LOCAL
...
!!!133935.cpp!!!	do_initialise_application_priv(in a_argc : int*, in a_argv : char**) : void
// LOCAL
...
!!!134191.cpp!!!	do_initialise_library_priv() : void
// DO_INIT_LIB
...
!!!134959.cpp!!!	gui_state(in a_application_name : string, in a_application_class : string)
// CTOR
...
!!!135215.cpp!!!	main(in a_resource_filename : string, in a_argc : int*, in a_argv : char**) : void
// LOCAL  
...
!!!135343.cpp!!!	notify_callback(in a_widget : Widget, in a_name : any, in a_call : any) : void
// LOCAL
std::string l_name;
gui_state *l_self;
// PRE
...
!!!135471.cpp!!!	warning_and_ask(in a_message : string, in a_yes_label : string, in a_no_label : string, in a_res_name : string, in a_help : string) : bool
// LOCAL
